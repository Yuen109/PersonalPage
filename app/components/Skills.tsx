...
const Skills = () => {
  return (
    <motion.div
      ...
      className="relative flex flex-col items-center justify-center mx-auto px-4 text-center"
    >
      <h3 className="absolute top-4 left-0 right-0 uppercase">Skills</h3>
      <div className="mt-16 md:mt-24 lg:mt-32 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Skill
          img={
