...
//         {/* Logo */}
//         <Link href={"/"}>
//           <p className="font-medium text-gray-400 cursor-pointer">Anson</p>
//         </Link>
...
//       >
//         <Link href={"Photo"}>
//           <p className="font-medium text-gray-400">Hobbies</p>
//         </Link>
//         <SocialIcon
  ...
  return (
    <header className="sticky top-0 p-5 flex flex-row items-center md:flex-1 z-20">
      ...
      >
        {/* Logo */}
        <Link href={"/"}>
          <p className="text-2xl uppercase font-extrabold text-gray-400 cursor-pointer">
            ay
          </p>
        </Link>
